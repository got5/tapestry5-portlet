...
package org.apache.tapestry5.portlet.internal;
...
public class PortletContextSymbolProvider implements SymbolProvider 
{

    private final Map<String, String> _properties = CollectionFactory.newCaseInsensitiveMap();

    public PortletContextSymbolProvider(PortletContext context)
    {
