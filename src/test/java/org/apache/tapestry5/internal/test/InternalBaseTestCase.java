...
public class InternalBaseTestCase extends TapestryTestCase implements Registry
{
    ...
    protected final PortletRequestGlobals mockPortletRequestGlobals()
    {
        return newMock(PortletRequestGlobals.class);
    }
    
    protected final PortletResourceResponseIdentifier mockPortletResourceResponseIdentifier()
    {
        return newMock(PortletResourceResponseIdentifier.class);
    }
   
    protected final ActionRequest mockActionRequest()
    {
