...
public class PortletLinkSourceImplTest extends InternalBaseTestCase
{
    ...
    public void create_page_render_link_by_name()
    {
        ...
        ComponentSource componentSource = mockComponentSource();
        ...
        PortletResourceResponseIdentifier resourceResponseIdentifier = mockPortletResourceResponseIdentifier();
        ...
        PortletLinkSource source = new PortletLinkSourceImpl(null, collector, typeCoercer, resolver, linkEncoder, globals, null, emptyConfiguration, 
        		componentSource, portletGlobals,resourceResponseIdentifier );
    ...
    private ComponentSource mockComponentSource() {
    ...
    public void component_event_from_other_page()
    {
        ...
        PortletLinkSource source = new PortletLinkSourceImpl(queue, collector, typeCoercer, null, linkEncoder, null, null, emptyConfiguration, 
        		componentSource, portletGlobals,resourceResponseIdentifier );
            ...
            Object... context)
    {
        ...
        PortletLinkSource source = new PortletLinkSourceImpl(queue, collector, typeCoercer, null, linkEncoder, null, null, configuration, 
        		componentSource, portletGlobals,resourceResponseIdentifier );
